    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <form action="{{ route('book_index') }}" method="GET" class="w-full max-w-lg">
                ...
                <x-button class="bg-gray-100 text-gray-900">{{ __('top') }}</x-button>
            </form>
        </h2>
    </x-slot>
    <!--ヘッダー[END]-->
                  ...
                  <div class="flex flex-col px-2 py-2">
                   <!-- カラム１ -->
                    ...
                    <div class="w-full md:w-1/1 px-3 mb-2 md:mb-0">
                      ...
                      <input name="item_address" class="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="">
                    </div>
...
<!--右側エリア[START]-->
    <div class="flex-1 col-2 text-gray-700 text-left bg-blue-100 px-4 py-2 m-2">
         <!-- 現在の本 -->
        @if (count($books) > 0)
